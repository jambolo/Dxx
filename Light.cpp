...
#if 0
void setPointValues(D3DCOLORVALUE const &     diffuse,
...
void setDirectionalValues(D3DCOLORVALUE const &     diffuse,
                          D3DCOLORVALUE const &     specular,
                          D3DCOLORVALUE const &     ambient,
...
void setSpotValues(D3DCOLORVALUE const &     diffuse,
                   D3DCOLORVALUE const &     specular,
                   D3DCOLORVALUE const &     ambient,
                   DirectX::XMFLOAT3 const & position,
                   DirectX::XMFLOAT3 const & direction,
...
void AmbientLight::set(D3DCOLORVALUE const & ambient)
{
...
void PointLight::set(D3DCOLORVALUE const &     ambient,
                     D3DCOLORVALUE const &     diffuse,
                     D3DCOLORVALUE const &     specular,
                     DirectX::XMFLOAT3 const & position,
                     float                     range,
...
void DirectionalLight::set(D3DCOLORVALUE const &     ambient,
                           D3DCOLORVALUE const &     diffuse,
                           D3DCOLORVALUE const &     specular,
                           DirectX::XMFLOAT3 const & direction)
{
...
SpotLight::SpotLight(int id)
    ...
    , attenuation1_(0.0f)
    , attenuation2_(0.0f)
    , theta_(DirectX::XM_PIDIV2)
    , phi_(DirectX::XM_PIDIV2)
{
}
    ...
    , phi_(phi)
{
    ...
    assert(attenuation0 != 0.0f || attenuation1 != 0.0f || attenuation2 != 0.0f);
    assert(theta > 0.0f && theta <= phi);
    assert(phi > 0.0f && phi < DirectX::XM_PI);
}

void SpotLight::set(D3DCOLORVALUE const &     ambient,
                    D3DCOLORVALUE const &     diffuse,
                    D3DCOLORVALUE const &     specular,
                    DirectX::XMFLOAT3 const & position,
                    DirectX::XMFLOAT3 const & direction,
